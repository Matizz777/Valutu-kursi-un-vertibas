-- Kā kļūt Valūtas kursu datubāzē ar Docker platformu?
...
-- SQL izmantotās Valūtu kursa datubāze, tabulas un tā izveide

create database valutaKurss;
...
-- SQL Valūtu kursa konkrētie Endpoint

SELECT title, description, pubDate
from channel
where pubdate like "%09 Nov 2022%";

SELECT title, description, pubDate
from channel
where pubdate like "%07 Nov 2022%" and description like "USD%";

-- SQL komanda, ar kuru var nolādē datus un saglabā DB failā
